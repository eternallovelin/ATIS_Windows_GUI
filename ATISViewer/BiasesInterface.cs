    ...
    public static class BiasesInterface  //This is biases interface for internal bias generator, ATIS V6
    {
       ...
       //public int[] BiasNormal = new int[] { 3050, 3150, 750, 620, 620, 700, 950, 2000, 400, 620, 320, 780, 350, 880, 850, 2950, 1150, 700, 970, 2680, 810, 2800, 1240, 3150, 1100, 820 };
        public static Dictionary<BiasName, int> BiasVoltage = new Dictionary<BiasName, int> { 
            {BiasName.CtrlbiasLP , 620},
            {BiasName.CtrlbiasLBBuff , 950},
            {BiasName.CtrlbiasDelTD , 400},
            {BiasName.CtrlbiasSeqDelAPS , 320},
            {BiasName.CtrlbiasDelAPS , 300},
            {BiasName.biasSendReqPdY , 850},
            {BiasName.biasSendReqPdX , 1150},
            {BiasName.CtrlbiasGB , 1100},
            {BiasName.TDbiasReqPuY , 850},
            {BiasName.TDbiasReqPuX , 1100},
            {BiasName.APSbiasReqPuY , 1100},
            {BiasName.APSbiasReqPuX , 900},
            {BiasName.APSVrefL , 3050},
            {BiasName.APSVrefH , 3170},
            {BiasName.APSbiasOut , 660},
            {BiasName.APSbiasHyst , 455},
            {BiasName.APSbiasTail , 520},
            {BiasName.TDbiasCas , 2005},
            {BiasName.TDbiasInv , 800},
            {BiasName.TDbiasDiffOff , 410},
            {BiasName.TDbiasDiffOn , 590},
            {BiasName.TDbiasDiff , 500},
            {BiasName.TDbiasFo , 3100},
            {BiasName.TDbiasRefr , 2900},
            {BiasName.TDbiasPR , 3100},
            {BiasName.TDbiasBulk , 2685},
            {BiasName.biasBuf , 0},
            {BiasName.biasAPSreset , 0},
        };
